<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewLE.aspx.cs" Inherits="ViewLE" %>
...
<h1>View Student&#39;s <span class="blue-text">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="349px" ScrollBars="Vertical" 
                                        ...
                                        <asp:GridView ID="DG" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="NUMBER OF POSTS">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle Width="180px" Font-Bold="True" Font-Size="Medium" 
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Height="349px" ScrollBars="Vertical" 
                                        ...
                                        <asp:GridView ID="DG1" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="POSTED BY">
                                                    <ItemStyle Width="180px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="POSTED ON">
