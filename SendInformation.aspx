<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SendInformation.aspx.cs" Inherits="SendInformation" %>
...
<h1>Send Information <span class="blue-text">to Students<asp:Label ID="LblDisp" runat="server" Visible="false"></asp:Label></span> <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    </h1>
