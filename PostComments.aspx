<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostComments.aspx.cs" Inherits="PostComments" %>
...
<h1>Post <span class="blue-text">Comments<asp:Label ID="LblDisp" runat="server" Visible="false"></asp:Label></span></h1>
...
<div style="padding: 10px 0px; width: 596px; text-align:justify; float: left;">
    ...
    <center>
				    <table>
				        <tr>
				            <td class="style2">
                                    <asp:Panel ID="P1" runat="server"  HorizontalAlign="Center" Width="388px">
                                           <table style="text-align: left; width: 291px; color: #CC6600; font-size: medium; font-weight: bold;">
				                                <tr style="border: thin solid #FFFFFF">
				                                    <td class="style1">
				                                        Title
				                                    </td>
				                                    <td>
                                                        <asp:TextBox ID="TxtTitle" Width="194px" runat="server" MaxLength="500" 
                                                            BorderColor="darkblue" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
				                                    </td>
				                                </tr>
				                                <tr style="border: thin solid #FFFFFF">
				                                    ...
				                                    <td>
                                                        <asp:TextBox ID="TxtPost" TextMode="MultiLine" Width="194px" runat="server" 
				                                ...
				                                <tr>
				                                    ...
				                                    <td>
				                                        <center>
                                                            <asp:Button ID="CmdSend" runat="server" Text="Post" onclick="CmdSend_Click" 
                                                                Width="65px"/>
