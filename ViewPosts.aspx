...
<h1>View <span class="blue-text">Posts<asp:Label ID="LblDisp" runat="server" Visible="false"></asp:Label></span></h1>
                                        ...
                                        <asp:GridView ID="DG" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:ButtonField Text="X">
                                                    <ItemStyle BackColor="#99FF99" Font-Bold="True" Font-Size="Larger" 
                                                        ForeColor="#FF3300" Width="10px" />
                                                </asp:ButtonField>
                                            </Columns>
